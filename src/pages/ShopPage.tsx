  ...
  return (
    <main className="min-h-screen bg-[#071f2d] text-white">
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 py-32 text-center">
        <div className="absolute inset-x-0 top-0 h-[34rem] bg-[radial-gradient(circle_at_50%_0%,rgba(255,255,255,0.12),transparent_32%),radial-gradient(circle_at_76%_22%,rgba(244,198,96,0.1),transparent_26%)]" />
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <p className="animate-fade-rise-delay mx-auto mt-8 max-w-2xl text-base leading-8 text-white/62 sm:text-lg">
            Study resources, templates, and downloads will arrive here later.
          </p>
        </div>
      </section>
    </main>
